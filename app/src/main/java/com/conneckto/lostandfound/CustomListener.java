    ...
    public void onClick(final View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.submitButton:
                ...
                lostAndFound.setName(ApplicationContextProvider.name);
                lostAndFound.setStudentClass(ApplicationContextProvider.stuClass);
                lostAndFound.setSection(ApplicationContextProvider.section);
